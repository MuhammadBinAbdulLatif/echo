...
function WidgetChatScreen() {
  ...
  const suggestions = useMemo(() => {
    ...
    return Object.keys(widgetSettings.defalutSuggestions).map((key) => {
      return widgetSettings.defalutSuggestions[
        key as keyof typeof widgetSettings.defalutSuggestions
      ];
    });
  }, [widgetSettings]);
  return (
    <>
      ...
      <AIConversation>
        <AIConversationContent>
          <InfiniteScrollTrigger
            ...
            noMoreText="No more items to show"
      ...
      {toUIMessages(messages.results ?? [])?.length === 1 && (
        <AISuggestions className="flex w-full items-center justify-center p-2">
