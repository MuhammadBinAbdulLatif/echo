...
export default function ConversatinIdView({ conversationId }: Props) {
  ...
  const subscription = useQuery(
    api.private.messages.getSubscriptionByOrganization
  );
      ...
      const errorMessage =
        ...
        error instanceof ConvexError
          ? // Access data and cast it to the type we expect
            (error.data as { code: string; message: string }).message
      ...
      <AIConversation className="min-h-[calc(100vh-175px)]">
        <AIConversationContent>
          <InfiniteScrollTrigger
            ...
            noMoreText="You have seen all of it"
          />
